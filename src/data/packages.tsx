...
export const norteAmericaPackages: Package[] = [
  ...
  },
  {
    ...
    features: [
      "Vuelos incluidos",
      "Hoteles 4 estrellas",
      "City tour (alto bajo manhattan)",
      "Translados de llegada + salida",
    ],
  },
  {
    title: "Orlando",
    ...
    features: [
      "Vuelos incluidos",
      "Translados de llegada y salida",
      "4 noches de alojamiento según categoría escogida (Desayuno donde el hotel los ofrezca complementario)",
      "Desayuno diario",
      "Traslados durante todo el recorrido",
      "Pasaporte de Disney 1 parque 1 día",
      "Pasaporte de Universal 1 parque 1 día básico",
      "1 Gift Card $25.00 x pasajero",
    ],
  },
  {
    title: "Miami",
    ...
    features: [
      "Vuelos incluidos",
      "Hoteles 3 estrellas",
      "Translados de llegada + salida regular (no en privado)",
      "Tour en barco por la bahia de miami",
    ],
  },
  {
    title: "Las Vegas",
    ...
    features: [
      ...
      "Hoteles 4 estrellas",
      "Translados de llegada + salida regular (no en privado)",
      "Paseo en helicoptero por el strip de las vegas",
    ],
  },
  {
    title: "Los Angeles",
    ...
    features: [
      "Vuelos incluidos",
      "Hoteles 4 estrellas",
      "Translados de llegada + salida regular",
      "City tour (español o portuñol)",
    ],
  },
  {
  ...
  },
  {
    ...
    features: [
      ...
      "Base hoteles de turista superior y primera",
      "Incluye 8 Desayuno, 7 Americanos y 1 Continental",
      "Incluye Hornblower Niagara Opera de Mayo a Octubre. Fuera de temporada será substituido por los túneles escénicos.",
      "Incluye Traslado de llegada y salida",
      "Precio de los circuitos incluyen visitas y excursiones indicadas en itinerario.",
      "Incluye manejo de 1 maleta por pasajero durante el recorrido, maletas adicionales serán cobradas",
    ],
  },
];
