    ...
    <section className="relative h-screen flex items-center justify-center overflow-hidden">
      ...
      <div className="relative z-10 text-center px-4 max-w-5xl mx-auto">
        ...
        >
          ...
          >
            Especialistas en crear experiencias de viaje únicas y personalizadas. 
            Desde playas paradisíacas hasta destinos culturales, tu aventura perfecta comienza aquí.
          </p>
        </motion.div>
        ...
        >
          <motion.button
            ...
            style={{ background: 'linear-gradient(135deg, #512DDB, #4E30B2)', boxShadow: '0 10px 40px rgba(81,45,219,0.35)' }}
          >
            <Sparkles className="w-5 h-5 group-hover:rotate-12 transition-transform" />
            <span className="text-lg" style={{ fontFamily: "'Lato', system-ui, sans-serif", fontWeight: 700 }}>
              Explorar Destinos
            </span>
