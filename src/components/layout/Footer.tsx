...
export function Footer() {
  ...
  const { whatsappUrl } = useWhatsApp(
    "¡Hola Moon Travel Co.! Me gustaría recibir más información.",
  );
  ...
  return (
    <footer
      ...
      style={{
        background:
          "linear-gradient(135deg, #0f172a 0%, #1a1a2e 60%, #4E30B2 100%)",
      }}
    >
      <div className="max-w-6xl mx-auto">
          ...
          <div className="text-center md:text-left">
            ...
            >
              ...
              <a
                ...
                className="block text-white/60 hover:text-[#D2C3F7] transition-colors"
              >
                WhatsApp: +57 304 649 5250
              </a>
              <a
          ...
          <div className="text-center md:text-left">
            ...
            <div className="flex items-center gap-3 justify-center md:justify-start">
              <a
                ...
                style={{
                  background: "rgba(210,195,247,0.12)",
                  border: "1px solid rgba(210,195,247,0.2)",
                }}
        ...
        <div className="border-t border-white/10 pt-6">
          ...
          >
            ...
            <br />
            En desarrollo de lo dispuesto en la Ley 679 de 2001 y la ley 1336 de
            2009, se advierte que la explotación sexual, la pornografía, el
            turismo sexual y demás formas de abuso sexual en Colombia son
            sancionados penal y administrativamente conforme a las leyes
            vigentes.
          </p>
        </div>
      </div>
