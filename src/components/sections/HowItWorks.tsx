...
export function HowItWorks() {
  const steps = [
    {
      ...
      description:
        "Completa el formulario o escríbenos directamente. Queremos conocer tus preferencias, fechas y presupuesto para diseñar tu viaje ideal",
    },
    {
      number: "02",
      icon: Heart,
      ...
      description:
        "Nuestro equipo diseñará una propuesta a medida con opciones de alojamiento, actividades y experiencias únicas",
    },
    {
      number: "03",
      icon: CheckCircle,
      ...
      description:
        "Aprueba los detalles, realizamos la reserva y te acompañamos durante todo el viaje con soporte 24/7",
    },
  ];
  ...
  return (
    <section
      ...
      style={{
        background:
          "linear-gradient(135deg, #0f172a 0%, #512DDB 50%, #4E30B2 100%)",
      }}
    >
      {/* Decorative elements */}
      <div
        className="absolute top-0 right-0 w-96 h-96 rounded-full blur-3xl"
        style={{ background: "rgba(210,195,247,0.08)" }}
      ></div>
      <div
        className="absolute bottom-0 left-0 w-96 h-96 rounded-full blur-3xl"
        style={{ background: "rgba(210,195,247,0.06)" }}
      ></div>
      ...
      <div className="max-w-6xl mx-auto relative z-10">
        ...
        >
          ...
          >
            Transformamos tus ideas en experiencias reales de manera fácil y
            transparente
          </p>
        </motion.div>
            ...
            return (
              ...
              >
                ...
                <motion.div
                  ...
                  style={{
                    background: "linear-gradient(135deg, #D2C3F7, #a78bfa)",
                  }}
                >
                  <span
                ...
                >
                  <Icon
                    className="w-10 h-10 text-[#D2C3F7]"
                    strokeWidth={1.5}
                  />
                </motion.div>
