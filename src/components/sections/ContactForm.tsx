...
export function ContactForm() {
  ...
  const handleChange = (
    ...
    if (name === "destino") {
      const isColombia =
        value.toLowerCase().includes("colombia") ||
        ["cartagena", "san andres", "medellin", "bogota", "santa marta"].some(
          (city) => value.toLowerCase().includes(city),
        );
            ...
            <div>
              ...
              <div className="flex gap-3">
                <button
                  type="button"
                  onClick={() =>
                    setFormData((prev) => ({ ...prev, tipoViaje: "nacional" }))
                  }
          ...
          <div className="mb-6">
            ...
            <AnimatePresence>
              {errors.mensaje && (
                ...
                >
                  <AlertCircle className="w-3.5 h-3.5" />
                  <span style={{ fontFamily: "'Lato', system-ui, sans-serif" }}>
                    {errors.mensaje}
                  </span>
                </motion.div>
              )}
